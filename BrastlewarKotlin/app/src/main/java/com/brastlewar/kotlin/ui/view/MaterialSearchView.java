...
import com.brastlewar.kotlin.utils.AnimationUtils;
import com.brastlewar.kotlin.utils.UIUtils;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void onVoiceClicked() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, getContext().getString(R.string.search_for_citizen));    // user hint
